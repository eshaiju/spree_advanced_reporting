Spree::Admin::ReportsController.class_eval do
  ...
  before_filter :basic_report_setup, :actions => [ :revenue, :units, :top_products, :top_customers, :geo_revenue, :geo_units, :count]
  ...
  ADVANCED_REPORTS ||= {}
  [ :revenue, :units, :count, :top_products, :top_customers, :geo_revenue, :geo_units].each do |x|
